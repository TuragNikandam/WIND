...
class _BottomNavBarState extends State<BottomNavBarWidget> {
  ...
  void popAllRoutes(int index) {
    switch (index) {
      case 0: // News
        if (NavigationService().newsKey.currentState != null && NavigationService().newsKey.currentState!.canPop()) {
          NavigationService()
              .newsKey
              .currentState!
        ...
        return;
      case 1: // Forum
        if (NavigationService().forumKey.currentState != null && NavigationService().forumKey.currentState!.canPop()) {
          NavigationService()
              .forumKey
              .currentState!
              .popUntil((route) => route.isFirst);
        ...
        return;
      case 2: // Voting
        if (NavigationService().votingKey.currentState != null && NavigationService().votingKey.currentState!.canPop()) {
          NavigationService()
              .votingKey
              .currentState!
              .popUntil((route) => route.isFirst);
